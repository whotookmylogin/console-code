...
const consoleLogProvider_1 = require("./consoleLogProvider");
let webSocketServer;
let consoleLogProvider;
/**
...
function activate(context) {
    ...
    consoleLogProvider = new consoleLogProvider_1.ConsoleLogProvider(context);
    // Register tree view
    ...
    context.subscriptions.push(startServerCommand, stopServerCommand, clearLogsCommand, exportLogsCommand);
...
async function startWebSocketServer() {
    ...
    try {
        ...
        webSocketServer = new webSocketServer_1.WebSocketServer(port, consoleLogProvider);
